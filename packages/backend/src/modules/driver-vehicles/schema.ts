...
const ownershipUnion = t.Union([t.Literal('own'), t.Literal('company'), t.Literal('leased')]);
const fuelTypeUnion = t.Union([t.Literal('diesel'), t.Literal('lpg'), t.Literal('lng'), t.Literal('electric'), t.Literal('hybrid')]);
const transmissionUnion = t.Union([t.Literal('manual'), t.Literal('automatic'), t.Literal('robotized')]);
const euroClassUnion = t.Union([t.Literal('euro3'), t.Literal('euro4'), t.Literal('euro5'), t.Literal('euro6')]);
...
export const createVehicleBody = t.Object({
  ...
  ownership: t.Optional(ownershipUnion),
  fuelType: t.Optional(fuelTypeUnion),
  engineVolumeL: t.Optional(t.Number()),
  powerHp: t.Optional(t.Number()),
  fuelTank1L: t.Optional(t.Number()),
  fuelTank2L: t.Optional(t.Number()),
  transmission: t.Optional(transmissionUnion),
  euroClass: t.Optional(euroClassUnion),
