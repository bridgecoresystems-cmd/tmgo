...
.search-fab { width: 44px; height: 44px; background: #18a058; color: white; border: none; border-radius: 12px; display: flex; align-items: center; justify-content: center; cursor: pointer; }
...
.see-all { background: none; border: none; color: #18a058; font-size: 0.82rem; font-weight: 600; cursor: pointer; padding: 0; }

.actions-row { display: flex; gap: 10px; margin-bottom: 24px; }
.action-btn { flex: 1; height: 48px; border-radius: 10px; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 0.88rem; font-weight: 700; cursor: pointer; border: none; background: white; color: #18a058; box-shadow: 0 1px 4px rgba(0,0,0,.06); }
.action-btn.primary { background: #18a058; color: white; }
...
.btn-find { background: #18a058; color: white; border: none; border-radius: 10px; padding: 12px 28px; font-weight: 700; font-size: 0.9rem; cursor: pointer; }
</style>
